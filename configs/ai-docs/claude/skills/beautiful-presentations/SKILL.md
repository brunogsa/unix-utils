...
## Patterns, mistakes, and tips

Common slide patterns (Hero, Content, Stat, Split), do/don't lists, and "Tips for Excellence" live in `references/usage-cheatsheet.md`. Load it when authoring slides.
...
- `usage-cheatsheet.md` - Common patterns, do/don't lists, tips
