...
These throwaway docs feed from durable design docs (ADR / HLD / LLD). See `~/.claude/skills/doc-standards/references/doc-writing.md` for the ownership + altitude rules that keep spec/plan from re-deriving them.
