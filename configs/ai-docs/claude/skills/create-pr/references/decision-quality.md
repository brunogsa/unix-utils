...
## TODO-Question prompts — example shape

Inline `// TODO: Question - <factual question>` markers that the next pass resolves:

- `// TODO: Question - what is the cache TTL? Is it configurable?`
- `// TODO: Question - what does staleTime: Infinity mean?`
