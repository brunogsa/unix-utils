...
Source: `code-review-pipeline/references/review-checklists.md#Code Design Checklist` + SRP/OCP/LSP/ISP/DIP from `code-review-pipeline/references/review-principles.md` + `code-standards`.
