...
flowchart TD
  ...
  remindTask0["Add [Remind] TaskList entry<br/>per remaining step (0-8)"]:::state
  ...
  step3["Step 3: Dispatch general-purpose subagent<br/>model sonnet, effort inherits, background (single, serial)<br/><br/>Reads step-3-fetch-cluster-propose.md<br/>+ review-principles.md<br/>fetch, filter, cluster, rank, propose"]:::dispatch
