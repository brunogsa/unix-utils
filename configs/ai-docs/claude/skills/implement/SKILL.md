...
Ask everything at once, in a single round, before any dispatch — the only round of questions in the whole run (may take two `AskUserQuestion` calls; it caps at 4 options each).
