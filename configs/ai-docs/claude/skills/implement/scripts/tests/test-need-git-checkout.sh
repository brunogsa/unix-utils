#!/usr/bin/env bash
# test-need-git-checkout.sh - plain-bash test file for
...
# run_script - invokes need-git-checkout.sh against a plan-file
...
# fresh plan fixture named plan_<slug>.md under work_dir,
